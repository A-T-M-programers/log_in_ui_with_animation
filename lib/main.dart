...
import 'package:log_in_ui_with_animation/wava_widget.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
                            ...
                            children: [
                              component2(
                                ...
                                () {
                                  ...
                                  // Navigator.push(context, MaterialPageRoute(builder: (route) => const WaveWidget()));
                                },
                              ),
  ...
  Widget component2(String string, double width, VoidCallback voidCallback) {
    ...
    return ClipRRect(
      borderRadius: BorderRadius.circular(15),
      child: BackdropFilter(
        filter: ImageFilter.blur(sigmaY: 50, sigmaX: 15),
        child: InkWell(
